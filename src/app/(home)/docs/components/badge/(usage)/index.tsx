...
import {importCode, usageCode} from '@/constants/documents/components/badge'
...
const Usage = () => {
  ...
  return (
    <div className='space-y-3'>
      ...
      <CodeBlock code={usageCode} language='react' theme={themes.synthwave84}>
        <div className='relative'>
          <CodeBlock.Code className='rounded-lg bg-black p-3'>
            <CodeBlock.LineContent>
              <CodeBlock.Token />
          ...
          <div className='absolute right-3 top-2 cursor-pointer rounded-md p-1 hover:bg-[#52525b]' onClick={() => copyCode(usageCode, 'usage')}>
            {idCoppied === 'usage' ? (
              <Image alt='Clipboard Icon' src={ClipboardCheckedIcon} width={20} height={20} />
            ) : (
              <Image alt='Clipboard-Checked Icon' src={ClipboardIcon} width={20} height={20} />
