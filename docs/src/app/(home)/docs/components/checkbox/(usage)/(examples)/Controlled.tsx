...
const Controlled = () => {
  ...
  const viewPreview = useMemo(
    () => (
      <div className='h-40 w-full flex-col flex-wrap justify-center gap-6 gap-y-0 overflow-auto rounded-md border p-3 py-8 tablet_max:block tablet_max:space-y-3 tablet_max:px-10 tablet_max:py-3'>
