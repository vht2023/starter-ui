...
import {demoCodePlacement} from '@/constants/documents/components/drawer'
  ...
  const viewPreview = useMemo(
    () => (
      <div className='flex-center h-96 w-full overflow-auto rounded-md border p-3 tablet_max:h-72'>
        ...
        <Drawer id='starterui-left-drawer' show={showDrawer} onHide={() => setShowDrawer(false)} placement='left' className='tablet_max:w-[300px]'>
    ...
    <div className='w-full space-y-3'>
      <div className='flex w-full items-center gap-6 border-b'>
        <div className={cn(['flex-center relative h-full cursor-pointer px-3', !showCode && 'font-semibold'])} onClick={() => setShowCode(false)}>
          ...
          {!showCode ? <motion.div className='preview-code-underline' layoutId='drawer-placement-preview-code-underline' /> : null}
        </div>
